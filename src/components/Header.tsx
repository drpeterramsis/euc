...
export default function Header({ onMenuClick }: { onMenuClick?: () => void }) {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 h-16 bg-black border-b border-gray-800 flex items-center justify-between px-4 z-40 shadow-sm overflow-x-hidden">
      ...
      <div className="flex items-center space-x-4">
        <Link to="/activity?tab=notifications" className="relative p-2 text-white hover:text-yellow-400 transition-colors shrink-0">
