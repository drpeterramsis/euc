...
import { utcToDisplay } from "../utils/timezone";
    ...
    <div className="bg-black rounded-2xl overflow-hidden shadow-lg">
      ...
      <div className="px-6 pt-6 pb-4 text-center">
        ...
        {nextEvent ? (
          ...
          <p className="text-gray-400 text-sm mb-1 font-sans">
            No upcoming events
          </p>
        )}
        ...
        {nextEvent && (
          <div className="flex items-end justify-center gap-2 mt-4">
            ...
            <span className="text-white/40 text-2xl font-light mb-5 font-mono">
              :
            </span>
            ...
            {timeline.map((event, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="flex flex-col items-center self-stretch pt-1.5">
                    {isNext ? (
                      <span className="relative flex items-center justify-center w-4 h-4 flex-shrink-0">
                        {/* COMMENT: Outer ping ring — ALWAYS YELLOW for high visibility on dark background */}
                        <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-yellow-400 opacity-90" />
                  ...
                  {/* Relative time badge */}
                  <span
                    className={`text-[10px] font-semibold px-2 py-0.5 rounded-full flex-shrink-0 font-sans
                    ${
                      event.isPast
