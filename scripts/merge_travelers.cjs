...
function main() {
  ...
  for (const t of travelers) {
    ...
    const flightDetails = {
      ...
      baggageAllowance: t.Outbound_Baggage_Allowance || "2 pieces * 23 Kg",
      ...
      departure: {
        ...
        aircraft: t.Outbound_Equipment || "",
        baggage: t.Outbound_Baggage_Allowance || "2 pieces * 23 Kg",
        meal: t.Outbound_Meal || "Meal",
      ...
      arrival: {
        ...
        baggage: t.Return_Baggage_Allowance || "2 pieces * 23 Kg",
  ...
  for (const u of usersJSON) {
    if (u.role === 'doctor' && (!u.flightDetails || !u.flightDetails.departure)) {
      u.flightDetails = {
        ...
        cabinClass: "Economy",
        baggageAllowance: "2 pieces * 23 Kg",
